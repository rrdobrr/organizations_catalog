...
Revision ID: 2238cd744e0f
Revises: 
Create Date: 2025-05-04 11:43:02.217951
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Название типа активности",
        ),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["activity_types.id"], ondelete="SET NULL"
        ),
...
def downgrade() -> None:
    ...
    op.create_index(
        "street_type_lookup_abbrev_idx", "street_type_lookup", ["abbrev"], unique=False
    )
    op.create_table(
        "loader_platform",
    ...
    op.create_table(
        ...
        sa.Column("blockce", sa.VARCHAR(length=4), autoincrement=False, nullable=True),
        sa.Column(
            "tabblock_id", sa.VARCHAR(length=16), autoincrement=False, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "pop", sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True
        ),
    ...
    op.drop_table("organizations_activity")
